        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div id="marcaFields" style="display:none;">
                    ...
                    ErrorMessage="El nombre de marca es requerido" ForeColor="Red" ValidationGroup="agregarMarca"></asp:RequiredFieldValidator>
                </div>
...
ErrorMessage="El nombre de categoria es requerido" ForeColor="Red" ValidationGroup="agregarCategoria"></asp:RequiredFieldValidator>
                </div>
            </div>
                <div class="modal-footer">
                    <asp:Button runat="server" ID="btnCancelarModal" Text="Cancelar" OnClientClick="cerrarModal(); return false;" OnClick="btnCancelarModal_Click" CssClass="btn btn-secondary"/>
                    <asp:Button runat="server" ID="btnGuardarModal" Text="Guardar" OnClientClick="return guardarModal();" OnClick="btnGuardarModal_Click" CssClass="btn btn-primary" ValidationGroup="agregarMarca agregarCategoria"/>
                </div>
            </div>
        </div>
    </div>
